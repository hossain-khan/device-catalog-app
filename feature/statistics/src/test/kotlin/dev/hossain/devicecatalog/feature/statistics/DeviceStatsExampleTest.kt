...
class DeviceStatsExampleTest {
    ...
    @Test
    fun `repository should return empty stats for no devices`() =
        runTest {
    ...
    @Test
    fun `repository should calculate correct stats for sample devices`() =
        runTest {
    ...
    @Test
    fun `repository should provide RAM distribution stats`() =
        runTest {
            // Given
            repository.setDevices(TestDeviceFactory.createSampleDevices())
    ...
    @Test
    fun `repository should provide SDK version distribution`() =
        runTest {
            // Given
            repository.setDevices(TestDeviceFactory.createSampleDevices())
    ...
    @Test
    fun `repository should provide ABI distribution`() =
        runTest {
            // Given
            repository.setDevices(TestDeviceFactory.createSampleDevices())
    ...
    @Test
    fun `repository should provide GPU distribution`() =
        runTest {
            // Given
            repository.setDevices(TestDeviceFactory.createSampleDevices())
