...
class NavigationDestinationTest {
    ...
    fun `verify all navigation destinations are defined`() {
        ...
        assertTrue("Home destination should exist", 
            destinations.any { it is NavigationDestination.Home })
        assertTrue("Devices destination should exist", 
            destinations.any { it is NavigationDestination.Devices })
        assertTrue("Search destination should exist", 
            destinations.any { it is NavigationDestination.Search })
        assertTrue("About destination should exist", 
