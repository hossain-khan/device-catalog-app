...
class ColorThemeTest {
    ...
    fun `verify colors follow Material 3 conventions`() {
        ...
        assertTrue("Blue80 should have higher red component than Blue40", 
            Blue80.red > Blue40.red)
        assertTrue("BlueGrey80 should have higher green component than BlueGrey40", 
            BlueGrey80.green > BlueGrey40.green)
        assertTrue("Teal80 should have higher blue component than Teal40", 
