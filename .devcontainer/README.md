...
- **VS Code Extensions**: Kotlin, Gradle, Java, GitHub Copilot support, and IntelliJ IDEA Keybindings
...
The dev container includes the following extensions:
- **Kotlin**: Kotlin language support
- **Gradle for Java**: Gradle build tool support
- **Java Extension Pack**: Comprehensive Java development tools
- **GitHub Copilot**: AI-powered code completion
- **GitHub Copilot Chat**: AI-powered chat assistant
- **IntelliJ IDEA Keybindings**: Familiar keyboard shortcuts for IntelliJ users
